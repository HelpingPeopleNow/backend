...
func TestProcessIntakeWorkerFields(t *testing.T) {
	...
	result, err := svc.ProcessIntake(t.Context(), "user-1", IntakeModeWorker, "I'm a plumber", nil, nil, "", "", nil, nil)
...
func TestProcessIntakeClientFields(t *testing.T) {
	...
	result, err := svc.ProcessIntake(t.Context(), "user-1", IntakeModeClient, "I'm Alvaro", nil, nil, "", "", nil, nil)
	require.NoError(t, err)
...
func TestProcessIntakeNoFieldsConversational(t *testing.T) {
	...
	result, err := svc.ProcessIntake(t.Context(), "user-1", IntakeModeWorker, "Hi!", nil, nil, "", "", nil, nil)
	require.NoError(t, err)
...
func TestProcessIntakeUnknownModeWithFields(t *testing.T) {
	...
	_, err := svc.ProcessIntake(t.Context(), "user-1", "bad_mode", "test", nil, nil, "", "", nil, nil)
	assert.Error(t, err)
...
func TestProcessIntakeLLMError(t *testing.T) {
	...
	_, err := svc.ProcessIntake(t.Context(), "user-1", IntakeModeWorker, "test", nil, nil, "", "", nil, nil)
	assert.Error(t, err)
...
func TestProcessIntakeWithLanguage(t *testing.T) {
	...
	result, err := svc.ProcessIntake(t.Context(), "user-1", IntakeModeWorker, "soy fontanero", nil, nil, "es", "", nil, nil)
	require.NoError(t, err)
	assert.Equal(t, "plumber", result.DetectedFields["profession"])
}
...
func TestProcessIntakeNoUserID(t *testing.T) {
	...
	result, err := svc.ProcessIntake(t.Context(), "", IntakeModeWorker, "plumber", nil, nil, "", "", nil, nil)
	require.NoError(t, err)
...
func TestProcessIntakeSaveErrorDoesNotFail(t *testing.T) {
	...
	result, err := svc.ProcessIntake(t.Context(), "user-1", IntakeModeWorker, "plumber", nil, nil, "", "", nil, nil)
	require.NoError(t, err)
	assert.Equal(t, "plumber", result.DetectedFields["profession"])
	assert.Equal(t, "", result.ConversationID)
}
...
func TestProcessIntakeWorkerTriggersReembed(t *testing.T) {
	...
	_, err := svc.ProcessIntake(t.Context(), "user-1", IntakeModeWorker, "plumber", nil, nil, "", "", nil, nil)
	require.NoError(t, err)
...
func TestProcessIntakeClientDoesNotTriggerReembed(t *testing.T) {
	...
	_, err := svc.ProcessIntake(t.Context(), "user-1", IntakeModeClient, "I'm Alvaro", nil, nil, "", "", nil, nil)
	require.NoError(t, err)
...
func TestProcessIntakeConversationalDoesNotTriggerReembed(t *testing.T) {
	...
	_, err := svc.ProcessIntake(t.Context(), "user-1", IntakeModeWorker, "hi", nil, nil, "", "", nil, nil)
	require.NoError(t, err)
